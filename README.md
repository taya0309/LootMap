...
| 文件 | 干什么 | 注意 |
|---|---|---|
| `Diablo-Spawn-FinaleOff-TEST.json` | **大菠萝免祭坛（保杂兵）**：进入混沌避难所（或随手开任意 1 个封印）大菠萝直接现身，不再需要「开满 5 个封印 + 杀 3 名守护者」；且出场时**不清杂兵** | 保持原样时，第四幕「恐怖终结」任务可能不推进；想恢复"出场清杂兵"，按文件里的说明删掉最后一条即可（文件里写得非常细） |
